    ### This code reads observations from "./data/household_power_consumption.txt" between 1/2/2007 and 2/2/2007 then plots Sub_metering_1 to 3 vs. date
    ...
    png(file = "plot3.png", width = 480 , height = 480, res = 72)               # initialize png capturing device
    plot(DF$Date, DF$Sub_metering_1, type="l", ylab = "Energy sub metering", xlab ="" )
                                                                                # plot first line 'Sub_metering_1' in black
